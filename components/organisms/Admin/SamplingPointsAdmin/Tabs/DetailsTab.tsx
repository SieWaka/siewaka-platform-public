import {
  ...
  SamplingPointData,
} from '../components/SamplingPointContainer';
...
export const DetailsTab = ({
  ...
  const detailsFirstColumn = [
    ...
    {
      title: 'País',
      data: getCountryName(samplingPoint.countryId, countries),
    },
    {
  ...
  const [data, setData] = useState({
    ...
    countryId: samplingPoint.countryId ?? '',
  ...
  return isEdit ? (
    ...
    >
      <div
        className={`flex flex-col space-y-3 lg:space-x-0 lg:grid lg:grid-cols-2 lg:gap-6`}
      >
