  ...
  const Node = {
    ...
    h2: (props: Omit<TextPropsParagraph, 'as'>) => (
      <h2
        ...
        className={classNames([
          props.className,
          'font-family-2 !font-bold text-2xl text-dark lg:text-black',
        ])}
      />
    ),
    h3: (props: Omit<TextPropsParagraph, 'as'>) => (
      <h3
        ...
        className={classNames([
          props.className,
          'font-family-2 font-bold text-base',
        ])}
      />
    ),
    ...
    p1: (props: Omit<TextPropsParagraph, 'as'>) => (
      <p
        {...props}
        className={classNames([props.className, 'text-base font-normal'])}
      />
    ),
    p2: (props: Omit<TextPropsParagraph, 'as'>) => (
      <p
        {...props}
        className={classNames([props.className, 'text-sm font-semibold'])}
      />
    ),
    p3: (props: Omit<TextPropsParagraph, 'as'>) => (
      <p
        {...props}
        className={classNames([props.className, 'text-xs font-medium'])}
      />
    ),
