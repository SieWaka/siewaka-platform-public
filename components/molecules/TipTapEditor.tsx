...
const TipTapEditor = ({
  ...
  return (
    <div className="mx-0">
      ...
      <EditorContent
        editor={editor}
        className="input-style bg-white rounded-base text-sm text-gray-500 border-l border-gray-300 h-fit mb-4 p-2 no-border"
      />
      {isSaved && (
      ...
      {error && (
        <span className="flex text-sm text-red-500 font-bold">{error}</span>
      )}
    </div>
  );
};
