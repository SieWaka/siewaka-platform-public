...
export function transformMeasurementValuesForOutput(
...
export function transformMeasurementValuesForPrisma(
  measurementValues: Record<string, number>
): Prisma.SampleMeasurementValueCreateWithoutSampleInput[] {
