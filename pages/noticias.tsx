    ...
    <div className="p-6 w-full flex flex-col space-y-3 overflow-hidden rounded-2xl border-2 my-6">
      <div className="space-y-1">
        <div className="flex justify-between">
          ...
          <Pill type="tertiary" className="pt-2">
            {startDate}
          </Pill>
        </div>
...
const NewsPost: NextPage<NewsPostProps> = ({ newsPosts }) => {
  return (
    <div
      className={
        'flex flex-wrap flex-grow content-start justify-center lg:bg-main-image lg:bg-white'
      }
    >
      <Head>
        <title>Sie Waka - Noticias</title>
      </Head>
      <MainContainer
        className={
          'w-full h-screen lg:h-full lg:w-3/5 lg:mx-4 mt-4 pt-8 lg:flex-grow-0'
        }
      >
