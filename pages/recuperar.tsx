...
const ResetPasswordEmailPage: NextPage = (props) => {
  ...
  return (
    <>
      <Head>
        <title>Sie Waka - Recuperar contraseña</title>
      </Head>
      <MainContainer
              ...
              <div className="m-3">
                {error != '' && (
                  <Text as="p3" className="text-error">
                    Ha ocurrido un error. Por favor, intenta de nuevo.(Error:{' '}
                    {error})
                  </Text>
                )}
              </div>
              ...
              >
                <div className="flex items-center justify-center flex-col px-2 space-y-4 mt-4">
                  ...
                  <p className="text-center p-0 lg:p-2">
                    Se ha enviado un correo a tu cuenta de correo electrónico.
