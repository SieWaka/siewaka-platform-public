...
const schema = yup
  .object({
    ...
    organizationName: yup
      .string()
      .required('Por favor ingrese el nombre de la organización'),
    organizationRole: yup
      .string()
      .required('Por favor ingrese el rol en la organización'),
    organizationCountryId: yup
      .string()
      .required('Por favor ingrese país de la organización'),
  })
  .required();
...
const StepOne: NextPage<ServerSideProps> = ({
  countries,
  ...
  return (
    <>
      <Head>
        <title>Sie Waka - Solicitar cuenta</title>
      </Head>
